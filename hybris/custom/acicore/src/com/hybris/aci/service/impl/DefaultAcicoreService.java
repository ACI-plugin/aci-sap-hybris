...
public class DefaultAcicoreService implements AcicoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAcicoreService.class);
	...
	{
		return DefaultAcicoreService.class.getResourceAsStream("/acicore/sap-hybris-platform.png");
	}
