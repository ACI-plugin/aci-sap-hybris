...
<html>
<head>
    <title>Welcome to acicore</title>
...
<div class="container">
    ...
    <h2>Welcome to "acicore" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/acicore-items.xml</b> - here you can model your items</li>
            <li><b>resources/acicore-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/acicore-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/acicore-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/acicore-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
